      ...
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-gray-400 bg-gray-800">
        ...
        <div className="flex items-center justify-between rounded-t-lg bg-gray-700 p-5">
          ...
          <button onClick={() => (!loading ? setModalData(null) : {})}>
            <RxCross2 className="text-2xl text-gray-5" />
          </button>
        </div>
        {/* Modal Form */}
        <form
        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-sm text-gray-5" htmlFor="lectureTitle">
          ...
          {/* Lecture Description */}
          <div className="flex flex-col space-y-2">
            <label className="text-sm text-gray-5" htmlFor="lectureDesc">
              Lecture Description{" "}
